    ...
    >
      ...
      >
        <div className="container mx-auto px-4 md:px-16 flex justify-center md:justify-between items-center">
          ...
          >
            {[
              { href: "https://x.com/gfort_agency", icon: TbBrandTwitter, label: "Twitter" },
              { href: "https://www.facebook.com", icon: TbBrandFacebook, label: "Facebook" },
              { href: "https://www.instagram.com/gfort_agency/", icon: TbBrandInstagram, label: "Instagram" },
        ...
        <div className="container mx-auto px-4 md:px-16 py-4 flex items-center justify-between">
          ...
          >
            <Link href="/" className="logo flex items-center" aria-label="Go to homepage">
              <Image src="/img/logo/logo-dark.png" alt="Gfort" width={100} height={100} className="w-auto h-auto" priority />
            </Link>
          </motion.div>
            ...
            <nav className="container mx-auto px-4" role="navigation" aria-label="Mobile navigation">
              ...
              <div className="mt-8 flex flex-col space-y-4">
                ...
                <div className="text-center">
                  <a href="mailto:info@gfort.org" className="text-gray-600 hover:text-[#059652] transition-colors duration-300">
                    info@gfort.org
                  </a>
                  <br />
