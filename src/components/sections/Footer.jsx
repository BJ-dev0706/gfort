  ...
  return (
    ...
    >
          ...
          <div className="flex justify-center text-center">
            <div className="max-w-2xl">
              ...
              <motion.p 
                ...
                viewport={{ once: true }}
              >
                Subscribe to the Gfort newsletter and be the first to receive
        ...
        >
          ...
          >
            ...
            >
              <Link href="/" className="flex items-center mb-4">
                <span className="text-2xl font-bold text-gray-400">Gfort</span>
              </Link>
            </motion.div>
            <div className="footer-contact">
              ...
              <p className="text-gray-200 mb-2">Calle de Innovación 123</p>
              <p className="text-gray-200 mb-4">Madrid, 28001, Spain</p>
              <motion.p 
                className="text-gray-200 mb-2"
                whileHover={{ x: 5, color: "#059652" }}
                transition={{ duration: 0.2 }}
          ...
          <motion.div variants={fadeInUp}>
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
            >
              Stay connected with Gfort for the latest updates and insights in
      ...
      >
        ...
        >
          © <span>Copyright</span>{" "}
          <strong className="text-gray-200 mx-1">Gfort</strong>
